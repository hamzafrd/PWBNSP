...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2024 at 02:32 PM
...
CREATE TABLE `mst_mahasiswa` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `registrasi_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `registrasi_mahasiswa`
--

CREATE TABLE `registrasi_mahasiswa` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `status` varchar(255) NOT NULL DEFAULT 'pending',
  `region_pribadi_id` bigint(20) UNSIGNED NOT NULL,
  `region_tempat_lahir_id` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `registrasi_mahasiswa`
--
...
ALTER TABLE `mst_mahasiswa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `mst_mahasiswa_user_id_foreign` (`user_id`),
  ADD KEY `mst_mahasiswa_registrasi_id_foreign` (`registrasi_id`);
...
--
-- Indexes for table `registrasi_mahasiswa`
--
ALTER TABLE `registrasi_mahasiswa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `registrasi_mahasiswa_region_pribadi_id_foreign` (`region_pribadi_id`),
  ADD KEY `registrasi_mahasiswa_region_tempat_lahir_id_foreign` (`region_tempat_lahir_id`);
...
--
-- AUTO_INCREMENT for table `registrasi_mahasiswa`
--
ALTER TABLE `registrasi_mahasiswa`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `mst_mahasiswa`
  ADD CONSTRAINT `mst_mahasiswa_registrasi_id_foreign` FOREIGN KEY (`registrasi_id`) REFERENCES `registrasi_mahasiswa` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `mst_mahasiswa_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `registrasi_mahasiswa`
--
ALTER TABLE `registrasi_mahasiswa`
  ADD CONSTRAINT `registrasi_mahasiswa_region_pribadi_id_foreign` FOREIGN KEY (`region_pribadi_id`) REFERENCES `regions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `registrasi_mahasiswa_region_tempat_lahir_id_foreign` FOREIGN KEY (`region_tempat_lahir_id`) REFERENCES `regions` (`id`) ON DELETE CASCADE;
COMMIT;
